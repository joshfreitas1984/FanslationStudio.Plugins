...
namespace FanslationStudio.Plugins.YamlDotNet;

public class YamlHelper: IYamlHelper
{
    public static ISerializer Serializer = CreateSerializer();
    public static IDeserializer Deserializer = CreateDeserializer();
