...
//{
//    public PrefabTextDumperServiceWrapper(IPluginLogger logger, string dumpFilePath, string regexPattern, bool enabled, string managedPath, string bepinExPath)
...
///// </summary>
//[BepInPlugin($"{MyPluginInfo.PLUGIN_GUID}.DynamicPrefabTextDumperPlugin", "DynamicPrefabTextDumperPlugin", MyPluginInfo.PLUGIN_VERSION)]
